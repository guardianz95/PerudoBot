...
namespace PerudoBot.Database.Sqlite.Migrations
{
    ...
    [Migration("20220517022819_BetSuccessNoLongerNullable")]
    partial class BetSuccessNoLongerNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PerudoBot.Database.Data.Bet", b =>
                {
                    ...
                    b.HasIndex("BettingPlayerId");

                    b.HasIndex("TargetActionId");

                    b.HasDiscriminator().HasValue("Bet");
                });
            ...
            modelBuilder.Entity("PerudoBot.Database.Data.Bet", b =>
                {
                    b.HasOne("PerudoBot.Database.Data.Player", "BettingPlayer")
                        .WithMany()
                        .HasForeignKey("BettingPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PerudoBot.Database.Data.Action", "TargetAction")
                        .WithMany()
                        .HasForeignKey("TargetActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BettingPlayer");

                    b.Navigation("TargetAction");
                });
